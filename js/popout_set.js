...
//            console.log(rent_data);
            ...
            if (char_data.advLargeSquire == true) {
                document.getElementById("a_1").style.visibility = "visible";
            }
            ...
            if (char_data.advHospital == true) {
                document.getElementById("a_3").style.visibility = "visible";
            }

            if (char_data.advShopping == true) {
                document.getElementById("a_4").style.visibility = "visible";
            }
            ...
            if (char_data.advMetroo == true) {
                document.getElementById("a_5").style.visibility = "visible";
            }

            if (char_data.advLowRate == true) {
                document.getElementById("a_6").style.visibility = "visible";
            }
            ...
            if (char_data.advSmallLiving == true) {
                document.getElementById("a_7").style.visibility = "visible";
            }
